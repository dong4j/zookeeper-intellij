...
public class ZkVirtualFileSystem extends DummyFileSystem {
    ...
    public void deleteFile(Object o, @NotNull VirtualFile virtualFile) {
        try {
    ...
    public VirtualFile createChildFile(Object o, @NotNull VirtualFile virtualFile, @NotNull String fileName) {
    ...
    public VirtualFile copyFile(Object o, @NotNull VirtualFile virtualFile, @NotNull VirtualFile virtualFile2,
                                @NotNull String s) {
        try {
            //todo
        } catch (Exception ignore) {
