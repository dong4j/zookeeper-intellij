                    ...
                    try {
                        ...
                        for (String part : parts) {
                            ...
                            if (curator.checkExists().forPath(newNode.getFilePath()) == null) {
                                if (nodeName.endsWith(".zip")) {
                                    ...
                                    curator.create().forPath(newNode.getFilePath(), ZkNodeVirtualFile.zip(entryName,
                                        "".getBytes()));
                                } else {
                        ...
                        if (newNode != null) {
                            ...
                            if (!fileType.getName().equals(FileTypes.UNKNOWN.getName())) {
                                VirtualFile virtualFile = zkProjectComponent.getFileSystem().findFileByPath(newNode
                                    .getFilePath());
